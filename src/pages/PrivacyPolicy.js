...
function PrivacyPolicy() {
    return (
        <div style={{ background: "#e1e1e1", padding: "16px" }}>
            <h2>Privacy Policy</h2>
            <p>
                Your privacy is important to us. It is Socialiite&#39;s policy
                ...
                <a href="https://socialiite.web.app">
                    https://socialiite.web.app
                </a>
                , and other sites we own and operate.{" "}
            </p>
            <p>
                This policy is effective as of 21 December 2021 and was last
